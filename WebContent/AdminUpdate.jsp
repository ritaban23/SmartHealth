...
<div class="wrapper">
		...
		<div><a href="AdminController?action=quit"style="color:white;"> Quit</a><br></div><br><br>
				...
				<h1 align="center" style="color: #2222B5;"><b>Administrator Update Page</b></h1>
					<% if(session.getAttribute("msg") != null){
						out.println(session.getAttribute("msg").toString());
						session.removeAttribute("msg");
				}%>
														<%  Admin admin = (Admin)request.getAttribute("admin");%>	
														<form name="UpdateForm" method="post" action="AdminController" onsubmit="return validate();">
														<div class="form-group">		 
																  <label class="control-label col-sm-2" for="First Name"  style="width: 21.666667%;">First Name</label>
														  <div class="col-sm-10">
																	 <input type="text" class="form-control" id="First name"  name="First" value= <%=admin.getFirst_name() %>>
																	 </div>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Last Name" style="width: 18.666667%;">Last Name</label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="Last Name" name="Last" value=<%=admin.getLast_name() %>>
														</div>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="UserName" style="width: 24.666667%;">UserName </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName"  name="username" value=<%=admin.getUser_name() %> /readonly>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="PrimaryEmail" style="width: 24.666667%;">Primary Email Id </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="PrimaryEmail" name="pemail" value=<%=admin.getPrimary_email() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Secondary Email" style="width: 24.666667%;">Secondary Email </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="SecondaryEmail" name="semail" value=<%=admin.getSecondary_email() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Postal Address" style="width: 24.666667%;">Postal Address </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName" name="postal" value=<%=admin.getPostal_address() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Postal Address" style="width: 24.666667%;">Password </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName" name="password" value=<%=admin.getPassword() %>>
														</div>
