...
<div class="wrapper">
		...
		<div><a href="NormalUserController?action=quit"style="color:white;"> Quit</a><br></div><br><br>
				...
				<h1 align="center" style="color: #2222B5;"><b>Send FriendRequest</b></h1>
					<% if(session.getAttribute("msg") != null){
						out.println(session.getAttribute("msg").toString());
						session.removeAttribute("msg");
				}%>
																<%  List<String> normal_users = (ArrayList<String>)request.getAttribute("all_normal_user");%>
																...
																<%for(String normal_user : normal_users){ %>
																	...
																	<div class="form-group">
																		 ...
																		 <a href="NormalUserController?action=addFriend&user_name=<%=normal_user%>"><button>Add Friend</button></a>	
																	</div>
																	<br>
																<%} %>
