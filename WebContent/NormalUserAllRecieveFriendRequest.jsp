...
<div class="wrapper">
		...
		<div><a href="NormalUserController?action=quit"style="color:white;"> Quit</a><br></div><br><br>
				...
				<h1 align="center" style="color: #2222B5;"><b>List Of Receive Request</b></h1>
					<% if(session.getAttribute("msg") != null){
						out.println(session.getAttribute("msg").toString());
						session.removeAttribute("msg");
				}%>
																<%  List<String> normal_users = (ArrayList<String>)request.getAttribute("all_recieve_request");%>
																...
																<%for(String normal_user : normal_users){ %>
																	...
																	<div class="form-group">
																		 ...
																		 <a href="NormalUserController?action=acceptFriendRequest&user_name=<%=normal_user%>"><button>Accept</button></a>
																		 <a href="NormalUserController?action=RejectFriendRequest&user_name=<%=normal_user%>"><button>Reject</button></a>	
																	</div>
																	<br>
																<%} %>
