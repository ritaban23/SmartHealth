...
<div class="wrapper">
		...
		<div><a href="NormalUserController?action=quit"style="color:white;"> Quit</a><br></div><br><br>
				...
				<h1 align="center" style="color: #2222B5;"><b>Normal User Update Page</b></h1>
					<% if(session.getAttribute("msg") != null){
						...
						session.removeAttribute("msg");
														...
														<form name="UpdateForm" method="post" action="NormalUserController" onsubmit="return validate();">
														<div class="form-group">		 
																  <label class="control-label col-sm-2" for="First Name"  style="width: 21.666667%;">First Name</label>
														  <div class="col-sm-10">
																	 <input type="text" class="form-control" id="First name"  name="First" value= <%=normal_user.getFirst_name() %>>
																	 </div>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Last Name" style="width: 18.666667%;">Last Name</label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="Last Name" name="Last" value=<%=normal_user.getLast_name() %>>
														</div>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="UserName" style="width: 24.666667%;">UserName </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName"  name="username" value=<%=normal_user.getUser_name() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="PrimaryEmail" style="width: 24.666667%;">Primary Email Id </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="PrimaryEmail" name="pemail" value=<%=normal_user.getPrimary_email() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Secondary Email" style="width: 24.666667%;">Secondary Email </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="SecondaryEmail" name="semail" value=<%=normal_user.getSecondary_email() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Postal Address" style="width: 24.666667%;">Postal Address </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName" name="postal" value=<%=normal_user.getPostal_address() %>>
														</div>
														<div class="form-group">
																	 <label class="control-label col-sm-2" for="Postal Address" style="width: 24.666667%;">Password </label>
																	 <div class="col-sm-10">
																	 <input type="text" class="form-control" id="UserName" name="password" value=<%=normal_user.getPassword() %>>
														</div>
														
													
														</div>
															<input type="hidden" name="page_type" value="normal_user_update">
															<div class="form-group">
